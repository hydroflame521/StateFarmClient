...
(function () {
    ...
    const sendChatMessage = function (text) {
        ...
        document.getElementById('chatIn').dispatchEvent(new KeyboardEvent('keydown', {
            key: 'Enter',
            code: 'Enter',
            keyCode: 13,
            which: 13,
    ...
    const mainLoop = function() {
        ...
        window[onUpdateFuncName] = function ( ss ) {
            ...
            if ( extract("freecam") ) {
                ...
                const xm = ss.myPlayer.actor.mesh.position.x;
                const ym = ss.myPlayer.actor.mesh.position.y;
                const zm = ss.myPlayer.actor.mesh.position.z;
